...
Original file is located at
    https://colab.research.google.com/drive/1C48d4XIjWympAgvkkhLjKBWvU2Ap5dId
...
"""# 1- Adult Dataset (87.75 - Accuracy: 82.15 - 81.10 - 83.03)
...
"""# 2- Abalone Dataset (87.87 - Accuracy: 86.19 - 86.11 - 86.27)"""
...
"""# 3- Auto MPG Dataset (73.33 - Accuracy: 73.10 - 73.94 - 71.42)"""
...
"""# 4- Breast Cancer Dataset (70.93 - Accuracy: 70.93 - 61.62 - 67.44)"""
...
"""# 5- Breast Cancer Wisconsin (Original) Dataset (75.23 - Accuracy: 80.95 - 83.80 - 82.38)"""
...
"""# 6- Credit Approval Dataset (64.25 - Accuracy: 64.25 - 65.21 - 63.28)"""
...
"""# 7- Iris Dataset (86.66 - Accuracy: 93.33 - 93.33 - 93.33)"""
...
"""# 8- Letter Recognition Dataset (70.95 - Accuracy: 69.55 - 69.10 - 63.83)"""
...
"""# 9- Lung Cancer Dataset (80 - Accuracy: 80 - 50 - 50)"""
...
"""# 10- Optical Recognition of Handwritten Digits Dataset (93.71 - Accuracy: 91.75 - 92.17 - 90.86)"""
...
"""# 11- Spambase Dataset (79.38 - Accuracy: 80.91 - 80.91 - 80.91)"""
...
"""# 12- Zoo Dataset (77.41 - Accuracy: 73.33 - 73.33 - 80.00)
...
"""# 13- Statlog (German Credit Data) Dataset (94.66 - Accuracy: 90.00 - 90.66 - 91.66)"""
...
"""# 14- Bank Marketing Dataset (88.27 - Accuracy: 84.65 - 83.50 - 85.00)"""
...
"""# 15- Diabetes 130-US hospitals for years 1999-2008 Dataset (100 - Accuracy: 100 - 100 - 100)"""
...
"""# 16- Glioma Grading Clinical and Mutation Features Dataset (98.01 - Accuracy: 92.4 - 94.04 - 91.26)"""
...
"""# 17- Sepsis Survival Minimal Clinical Records Dataset (76.88 - Accuracy: 76.63 - 76.63 - 76.63)"""
...
dt_gain_ratio = DecisionTreeClassifier(criterion='entropy', splitter='best', max_features='log2')
dt_gini = DecisionTreeClassifier(criterion='gini')
svm_model = SVC(probability=True)
tf_model = tf.keras.Sequential([tf.keras.layers.Dense(64, activation='relu'),
                                tf.keras.layers.Dense(1, activation='sigmoid')])
scikit_dt_model = DecisionTreeClassifier()
classifiers = [dt_info_gain, dt_gain_ratio, dt_gini, svm_model, tf_model, scikit_dt_model]
adaboost_model = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(), n_estimators=6)
...
class AdaBoostClassifier:
    ...
    def fit(self, X, y):
        ...
        for _ in range(self.n_classifiers):
            ...
            classifier.fit(X, y, sample_weights=weights)
    ...
    def predict(self, X):
        ...
        final_predictions = np.sign(np.sum(classifier_preds, axis=0))
...
print(classification_report(y_test, predictions, labels=unique_labels, target_names=[str(c) for c in unique_labels]))
